...
prompt Created by gelli on Thursday, July 25, 2024
set feedback off
set define off
...
alter table COMMUNITYMEMBER disable constraint SYS_C0010900;
alter table COMMUNITYMEMBER disable constraint SYS_C0010901;
prompt Disabling foreign key constraints for SERVICEGIVER...
alter table SERVICEGIVER disable constraint SYS_C0010931;
prompt Disabling foreign key constraints for BABYSITTING...
alter table BABYSITTING disable constraint SYS_C0010935;
prompt Disabling foreign key constraints for BIRTH...
alter table BIRTH disable constraint SYS_C0010908;
prompt Disabling foreign key constraints for CLEANING...
alter table CLEANING disable constraint SYS_C0010938;
prompt Disabling foreign key constraints for CONSULTING...
alter table CONSULTING disable constraint SYS_C0010953;
prompt Disabling foreign key constraints for DONATION...
alter table DONATION disable constraint SYS_C0010914;
alter table DONATION disable constraint SYS_C0010915;
prompt Disabling foreign key constraints for EXTERNAL_DONOR...
alter table EXTERNAL_DONOR disable constraint SYS_C0010921;
prompt Disabling foreign key constraints for SPENDING...
alter table SPENDING disable constraint SYS_C0010928;
prompt Disabling foreign key constraints for TIMES...
alter table TIMES disable constraint SYS_C0010955;
prompt Disabling foreign key constraints for YOLEDETSERVICEGIVER...
alter table YOLEDETSERVICEGIVER disable constraint SYS_C0010957;
alter table YOLEDETSERVICEGIVER disable constraint SYS_C0010958;
...
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (1, 3382, 'Beit Knesset', '341731534', 'Har Yitzhak', 'Netanya', 191);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (2, 3476, 'Kehila', '451911393', 'Orot David', 'Maale Adumim', 230);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (3, 2571, 'Kehila', '796697373', 'Har Rachel', 'Dimona', 79);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (4, 2072, 'Neighborhood', '777838796', 'Beit Menashe', 'Kfar Saba', 395);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (5, 1618, 'Kehila', '126998789', 'Beit David', 'Eilat', 43);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (6, 3352, 'Kehila', '661315165', 'Bnei Rivka', 'Afula', 456);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (7, 2619, 'Kehila', '685569465', 'Neve Rachel', 'Kfar Saba', 50);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (8, 2876, 'Beit Knesset', '364373528', 'Har Ephraim', 'Zichron Yaakov', 187);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (9, 2789, 'Neighborhood', '893627769', 'Orot Rina', 'Kfar Saba', 308);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (10, 4289, 'Beit Knesset', '471997979', 'Neve Eliyaho', 'Ramat Gan', 92);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (11, 3748, 'Neighborhood', '125634364', 'Orot Dan', 'Dimona', 306);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (12, 1540, 'Beit Knesset', '588753958', 'Neve Menashe', 'Rehovot', 487);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (13, 4335, 'Kehila', '359293578', 'Har Shimon', 'Lod', 286);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (14, 4539, 'Kehila', '244849558', 'Har Gad', 'Kfar Saba', 161);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (15, 1163, 'Beit Knesset', '659557635', 'Orot Menashe', 'Kiryat Gat', 181);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (16, 2191, 'Kehila', '859638477', 'Bnei Rina', 'Jerusalem', 355);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (17, 1619, 'Neighborhood', '968845448', 'Bnei Rachel', 'Hadera', 436);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (18, 1314, 'Beit Knesset', '942163524', 'Ohel Dvora', 'Herzliya', 68);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (19, 2312, 'Neighborhood', '562614785', 'Bnei Ephraim', 'Raanana', 352);
insert into COMMUNITY (community_id, monthly_donation, community_type, phone_number, c_name, c_location, c_numofmembers)
values (20, 1503, 'Neighborhood', '787488753', 'Har Yosef', 'Kiryat Gat', 321);
commit;
...
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('77 Brendan', to_date('17-04-1970', 'dd-mm-yyyy'), 147, 7, 100000127, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('5 Weir Street', to_date('11-01-1971', 'dd-mm-yyyy'), 148, 8, 100000195, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('56 Goiania Road', to_date('07-11-1978', 'dd-mm-yyyy'), 149, 15, 100000049, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('64 Bracco Road', to_date('24-01-1992', 'dd-mm-yyyy'), 150, 17, 100000266, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('1 Alan Blvd', to_date('19-02-1990', 'dd-mm-yyyy'), 151, 17, 100000368, to_date('19-04-2017', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('55 Wes Blvd', to_date('15-08-2001', 'dd-mm-yyyy'), 152, 5, 100000065, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('89 Fukui Blvd', to_date('17-10-2002', 'dd-mm-yyyy'), 153, 9, 100000209, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('69 Margolyes Road', to_date('19-09-1967', 'dd-mm-yyyy'), 154, 10, 100000115, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('54 Marie Drive', to_date('21-06-2002', 'dd-mm-yyyy'), 155, 15, 100000047, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('1 Cumming', to_date('18-08-1984', 'dd-mm-yyyy'), 156, 14, 100000197, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('362 Saul Road', to_date('09-04-1996', 'dd-mm-yyyy'), 157, 9, 100000300, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('257 Macy Street', to_date('01-04-1983', 'dd-mm-yyyy'), 158, 19, 100000386, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('9 Posener Ave', to_date('07-08-1978', 'dd-mm-yyyy'), 159, 20, 100000381, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('26 Nick Road', to_date('03-06-1966', 'dd-mm-yyyy'), 160, 12, 100000236, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('69 Pepper Street', to_date('12-05-1973', 'dd-mm-yyyy'), 161, 3, 100000250, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('3 Hilton Road', to_date('28-01-1994', 'dd-mm-yyyy'), 162, 10, 100000031, to_date('19-04-2017', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('100 Malcolm Drive', to_date('08-09-1999', 'dd-mm-yyyy'), 163, 20, 100000009, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('521 Kongserbg Road', to_date('05-11-1993', 'dd-mm-yyyy'), 164, 7, 100000240, to_date('02-02-2018', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('401 Essen Blvd', to_date('03-05-1969', 'dd-mm-yyyy'), 165, 17, 100000303, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('10 Leeds Ave', to_date('05-11-1978', 'dd-mm-yyyy'), 166, 2, 100000030, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('79 Cattrall Ave', to_date('26-01-1975', 'dd-mm-yyyy'), 167, 2, 100000387, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('27 Nightingale Road', to_date('09-01-1996', 'dd-mm-yyyy'), 168, 9, 100000298, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('454 Peebles Street', to_date('07-08-1961', 'dd-mm-yyyy'), 169, 15, 100000065, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('868 Forrest Road', to_date('14-12-1991', 'dd-mm-yyyy'), 170, 2, 100000184, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('525 Hartmannsdorf Street', to_date('31-01-1961', 'dd-mm-yyyy'), 171, 6, 100000382, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('6 Mellencamp Street', to_date('27-08-1987', 'dd-mm-yyyy'), 172, 20, 100000251, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('413 Keener Drive', to_date('12-10-1971', 'dd-mm-yyyy'), 25, 2, 100000228, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('40 Cube Drive', to_date('17-10-1989', 'dd-mm-yyyy'), 26, 8, 100000006, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('88 Sutherland', to_date('12-01-1966', 'dd-mm-yyyy'), 28, 16, 100000377, to_date('19-04-2017', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('8 Garcia Ave', to_date('07-05-1967', 'dd-mm-yyyy'), 30, 6, 100000267, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('290 Coburn Drive', to_date('21-04-1970', 'dd-mm-yyyy'), 31, 7, 100000229, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('76 Blaine', to_date('24-01-1972', 'dd-mm-yyyy'), 34, 20, 100000133, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('86 Chemnitz Street', to_date('13-09-1980', 'dd-mm-yyyy'), 35, 7, 100000359, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('31 Horb', to_date('18-06-2003', 'dd-mm-yyyy'), 38, 19, 100000233, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('61st Street', to_date('30-12-1981', 'dd-mm-yyyy'), 39, 18, 100000272, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('30 Thornton', to_date('09-05-1982', 'dd-mm-yyyy'), 42, 14, 100000330, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('90 Napolitano Street', to_date('11-02-1960', 'dd-mm-yyyy'), 43, 8, 100000367, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('17 Wheel Road', to_date('28-09-1987', 'dd-mm-yyyy'), 47, 20, 100000236, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('48 Brody Road', to_date('31-07-1984', 'dd-mm-yyyy'), 48, 2, 100000156, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('57 Tomei Road', to_date('16-11-1979', 'dd-mm-yyyy'), 50, 17, 100000183, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('52 English Street', to_date('05-02-1964', 'dd-mm-yyyy'), 51, 7, 100000055, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('75 Rickles Street', to_date('08-08-1981', 'dd-mm-yyyy'), 54, 4, 100000287, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('364 Kelli Road', to_date('14-08-1963', 'dd-mm-yyyy'), 55, 12, 100000134, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('55 Garza Road', to_date('16-03-2000', 'dd-mm-yyyy'), 58, 15, 100000084, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('71 Rose Road', to_date('04-01-1999', 'dd-mm-yyyy'), 59, 9, 100000259, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('12 Storrington Drive', to_date('28-01-1992', 'dd-mm-yyyy'), 61, 9, 100000145, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('99 Oakland Street', to_date('02-04-1989', 'dd-mm-yyyy'), 64, 4, 100000198, to_date('16-10-2008', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('8 Loreena Street', to_date('07-12-1983', 'dd-mm-yyyy'), 65, 15, 100000371, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('24 Ronnie Blvd', to_date('21-07-1986', 'dd-mm-yyyy'), 68, 8, 100000262, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('76 Bell Street', to_date('29-03-2000', 'dd-mm-yyyy'), 69, 14, 100000373, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('82nd Street', to_date('30-10-1979', 'dd-mm-yyyy'), 72, 19, 100000234, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('70 Louisville Blvd', to_date('01-12-1985', 'dd-mm-yyyy'), 73, 13, 100000200, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('64 Hayes Drive', to_date('09-06-1962', 'dd-mm-yyyy'), 75, 8, 100000218, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('97 Cate Street', to_date('02-02-1989', 'dd-mm-yyyy'), 76, 20, 100000037, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('81st Street', to_date('03-07-1998', 'dd-mm-yyyy'), 79, 20, 100000273, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('2 Rauhofer Street', to_date('19-04-2003', 'dd-mm-yyyy'), 80, 14, 100000122, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('147 Selma Drive', to_date('08-02-1993', 'dd-mm-yyyy'), 83, 1, 100000243, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('43 Bening Blvd', to_date('21-09-1967', 'dd-mm-yyyy'), 84, 13, 100000148, to_date('02-02-2018', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('12 Fukushima', to_date('23-04-1996', 'dd-mm-yyyy'), 87, 2, 100000315, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('68 Leelee Ave', to_date('30-03-1993', 'dd-mm-yyyy'), 88, 7, 100000041, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('34 LaMond Street', to_date('23-06-1967', 'dd-mm-yyyy'), 91, 5, 100000062, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('56 Dean Ave', to_date('10-05-1995', 'dd-mm-yyyy'), 92, 18, 100000193, to_date('19-04-2017', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('84 Wes Blvd', to_date('15-02-1999', 'dd-mm-yyyy'), 95, 11, 100000371, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('47 Andrea', to_date('31-12-1981', 'dd-mm-yyyy'), 96, 14, 100000055, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('3 North Sydney Blvd', to_date('11-04-1972', 'dd-mm-yyyy'), 98, 1, 100000236, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('12nd Street', to_date('21-03-1980', 'dd-mm-yyyy'), 101, 2, 100000236, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('37 Studi Road', to_date('24-01-1979', 'dd-mm-yyyy'), 102, 19, 100000106, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('523 Buffalo Street', to_date('19-10-1995', 'dd-mm-yyyy'), 104, 7, 100000004, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('950 Vienna Road', to_date('14-05-1987', 'dd-mm-yyyy'), 107, 16, 100000033, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('41 MacIsaac Street', to_date('08-01-1969', 'dd-mm-yyyy'), 108, 3, 100000178, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('29 Gettysburg Street', to_date('03-12-1999', 'dd-mm-yyyy'), 111, 20, 100000081, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('71 Rodriguez Street', to_date('11-02-1975', 'dd-mm-yyyy'), 112, 13, 100000013, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('94 Lindo Street', to_date('21-01-2004', 'dd-mm-yyyy'), 115, 16, 100000168, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('39 Rosas Street', to_date('26-12-1978', 'dd-mm-yyyy'), 116, 2, 100000311, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('30 Derrick Ave', to_date('02-04-1960', 'dd-mm-yyyy'), 119, 9, 100000123, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('87 Stuart Street', to_date('04-07-1969', 'dd-mm-yyyy'), 120, 19, 100000159, to_date('02-02-2018', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('69 Smith', to_date('10-03-1978', 'dd-mm-yyyy'), 123, 8, 100000320, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('7 Costello Road', to_date('28-02-1989', 'dd-mm-yyyy'), 124, 15, 100000089, to_date('16-10-2008', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('93 Fairbanks Road', to_date('01-01-2001', 'dd-mm-yyyy'), 127, 11, 100000280, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('97 Shoreline', to_date('17-04-1968', 'dd-mm-yyyy'), 128, 12, 100000222, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('24 MacIsaac Blvd', to_date('02-05-1971', 'dd-mm-yyyy'), 131, 2, 100000149, to_date('19-04-2017', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('2 Conners Street', to_date('01-02-1962', 'dd-mm-yyyy'), 132, 6, 100000355, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('87 Charlize Blvd', to_date('16-11-1997', 'dd-mm-yyyy'), 135, 11, 100000397, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('72 Bristol Road', to_date('26-06-1961', 'dd-mm-yyyy'), 136, 14, 100000137, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('4 MÃƒÂ¶nchengladbach Road', to_date('28-02-1977', 'dd-mm-yyyy'), 139, 1, 100000372, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('563 Bartlesville Street', to_date('04-02-1961', 'dd-mm-yyyy'), 140, 5, 100000142, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('61 Williams', to_date('07-05-1999', 'dd-mm-yyyy'), 144, 19, 100000305, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('9 Goodall Street', to_date('31-01-1962', 'dd-mm-yyyy'), 145, 7, 100000195, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('586 Joely Ave', to_date('03-10-1975', 'dd-mm-yyyy'), 173, 3, 100000332, to_date('02-02-2018', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('91st Street', to_date('06-02-1975', 'dd-mm-yyyy'), 174, 2, 100000007, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('18 Winter Drive', to_date('15-01-1997', 'dd-mm-yyyy'), 177, 18, 100000396, to_date('19-04-2017', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('81 Cummings Street', to_date('20-11-1988', 'dd-mm-yyyy'), 178, 19, 100000194, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('77 Lea Ave', to_date('23-01-1975', 'dd-mm-yyyy'), 181, 17, 100000103, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('90 Robin', to_date('18-11-1990', 'dd-mm-yyyy'), 182, 8, 100000075, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('548 Mann Drive', to_date('03-09-1972', 'dd-mm-yyyy'), 185, 3, 100000370, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('9 Alexandria Blvd', to_date('22-02-1999', 'dd-mm-yyyy'), 186, 2, 100000091, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('1 Kershaw Drive', to_date('14-05-1982', 'dd-mm-yyyy'), 189, 10, 100000016, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('328 Harrison Street', to_date('22-03-1988', 'dd-mm-yyyy'), 190, 19, 100000331, to_date('19-04-2017', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('73 Jovovich Road', to_date('30-01-1973', 'dd-mm-yyyy'), 193, 12, 100000361, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('83 Broadbent Road', to_date('04-05-1965', 'dd-mm-yyyy'), 194, 2, 100000173, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
commit;
prompt 100 records committed...
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('32 Kapanka Road', to_date('22-07-1989', 'dd-mm-yyyy'), 197, 4, 100000347, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('467 Nicholson Road', to_date('24-03-1970', 'dd-mm-yyyy'), 198, 4, 100000205, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('92nd Street', to_date('17-04-1971', 'dd-mm-yyyy'), 175, 6, 100000267, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('689 Alfie Road', to_date('30-03-1983', 'dd-mm-yyyy'), 176, 10, 100000146, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('46 Annette', to_date('25-07-1993', 'dd-mm-yyyy'), 179, 19, 100000340, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('1 Andie Drive', to_date('31-12-2003', 'dd-mm-yyyy'), 180, 17, 100000054, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('20 Badalucco Ave', to_date('10-08-1981', 'dd-mm-yyyy'), 183, 11, 100000278, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('611 Ronnie', to_date('11-09-1978', 'dd-mm-yyyy'), 184, 6, 100000219, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('35 Rene Blvd', to_date('26-11-1993', 'dd-mm-yyyy'), 187, 10, 100000170, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('36 Moss', to_date('12-03-2000', 'dd-mm-yyyy'), 188, 6, 100000288, to_date('19-04-2017', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('28 Derrick Drive', to_date('03-06-1978', 'dd-mm-yyyy'), 191, 13, 100000211, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('40 Brent Street', to_date('13-04-1977', 'dd-mm-yyyy'), 192, 13, 100000153, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('124 Scott Road', to_date('03-09-1990', 'dd-mm-yyyy'), 195, 11, 100000161, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('223 Mickey', to_date('19-06-1990', 'dd-mm-yyyy'), 196, 20, 100000301, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('13 Mechelen Drive', to_date('10-05-2000', 'dd-mm-yyyy'), 199, 20, 100000316, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('35 Nuernberg Ave', to_date('15-01-1964', 'dd-mm-yyyy'), 200, 11, 100000090, null, null);
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('72nd Street', to_date('14-10-2001', 'dd-mm-yyyy'), 1, 12, 100000223, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('11 Summer Street', to_date('04-09-1961', 'dd-mm-yyyy'), 2, 8, 100000170, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('57 McDonald Street', to_date('24-03-1961', 'dd-mm-yyyy'), 3, 9, 100000371, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('96 Martin Street', to_date('04-07-1967', 'dd-mm-yyyy'), 4, 4, 100000131, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('38 Marshall Road', to_date('20-11-2004', 'dd-mm-yyyy'), 5, 12, 100000257, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('89 Keeslar Drive', to_date('05-04-1999', 'dd-mm-yyyy'), 6, 9, 100000381, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('61st Street', to_date('06-09-2001', 'dd-mm-yyyy'), 7, 18, 100000080, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('989 Zahn Drive', to_date('29-01-1984', 'dd-mm-yyyy'), 8, 14, 100000143, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('63 Tokushima Road', to_date('18-05-1966', 'dd-mm-yyyy'), 9, 6, 100000392, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('98 Luedenscheid Drive', to_date('04-07-1987', 'dd-mm-yyyy'), 10, 11, 100000344, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('17 Keener Street', to_date('08-09-1969', 'dd-mm-yyyy'), 11, 11, 100000338, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('38 Nathan Drive', to_date('27-07-1961', 'dd-mm-yyyy'), 12, 4, 100000297, to_date('19-04-2017', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('92nd Street', to_date('01-11-1988', 'dd-mm-yyyy'), 13, 1, 100000236, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('32 Shreveport Ave', to_date('20-10-1960', 'dd-mm-yyyy'), 14, 4, 100000196, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('88 Jackie Drive', to_date('22-04-1995', 'dd-mm-yyyy'), 15, 19, 100000164, to_date('02-02-2018', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('44 Mason Street', to_date('06-07-1986', 'dd-mm-yyyy'), 16, 19, 100000261, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('75 Shannon Road', to_date('22-05-1974', 'dd-mm-yyyy'), 17, 13, 100000088, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('31 Jeremy Drive', to_date('24-08-1990', 'dd-mm-yyyy'), 18, 3, 100000216, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('16 Hatchet Drive', to_date('27-05-1977', 'dd-mm-yyyy'), 19, 5, 100000353, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('76 Satriani Road', to_date('09-11-1995', 'dd-mm-yyyy'), 20, 13, 100000103, to_date('19-04-2017', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('37 Lorraine Drive', to_date('06-12-1993', 'dd-mm-yyyy'), 21, 4, 100000355, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('100 Forrest Ave', to_date('29-02-2000', 'dd-mm-yyyy'), 22, 15, 100000252, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('168 AniÃƒÂ¨res Drive', to_date('22-06-1999', 'dd-mm-yyyy'), 23, 17, 100000255, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('386 Rachid Street', to_date('30-08-1973', 'dd-mm-yyyy'), 24, 1, 100000225, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('98 Santa Clarita Ave', to_date('14-06-2002', 'dd-mm-yyyy'), 27, 20, 100000220, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('62nd Street', to_date('30-05-1994', 'dd-mm-yyyy'), 29, 18, 100000005, to_date('02-02-2018', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('81 Mathis Street', to_date('15-10-1998', 'dd-mm-yyyy'), 32, 1, 100000187, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('97 West Monroe Drive', to_date('20-06-1991', 'dd-mm-yyyy'), 33, 20, 100000004, to_date('02-02-2018', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('15 Dalley Street', to_date('17-05-2004', 'dd-mm-yyyy'), 36, 6, 100000371, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('528 Mantova Ave', to_date('07-09-1981', 'dd-mm-yyyy'), 37, 9, 100000150, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('33rd Street', to_date('25-01-1981', 'dd-mm-yyyy'), 40, 15, 100000225, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('90 Marina Road', to_date('19-10-1962', 'dd-mm-yyyy'), 41, 2, 100000141, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('4 Londrina Drive', to_date('14-09-1986', 'dd-mm-yyyy'), 44, 4, 100000394, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('94 Pleasure Road', to_date('05-08-1966', 'dd-mm-yyyy'), 46, 14, 100000019, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('90 Osbourne Street', to_date('22-01-1969', 'dd-mm-yyyy'), 49, 13, 100000013, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('980 Milton Road', to_date('14-01-1981', 'dd-mm-yyyy'), 52, 15, 100000250, to_date('02-02-2018', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('89 Henstridge Ave', to_date('27-06-1965', 'dd-mm-yyyy'), 53, 15, 100000046, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('29 Redwood City Ave', to_date('12-06-1980', 'dd-mm-yyyy'), 56, 11, 100000307, to_date('08-03-2013', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('708 Vienna Road', to_date('11-07-1993', 'dd-mm-yyyy'), 57, 10, 100000129, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('749 O''Neal Street', to_date('24-05-1995', 'dd-mm-yyyy'), 60, 7, 100000124, to_date('16-10-2008', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('72nd Street', to_date('19-09-1983', 'dd-mm-yyyy'), 62, 19, 100000336, to_date('08-03-2013', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('81 Delta Road', to_date('26-09-2001', 'dd-mm-yyyy'), 63, 4, 100000055, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('40 Ike Ave', to_date('16-04-1979', 'dd-mm-yyyy'), 66, 20, 100000354, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('27 Angela Road', to_date('01-08-1989', 'dd-mm-yyyy'), 67, 13, 100000076, to_date('02-02-2018', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('606 Heron Drive', to_date('13-10-1990', 'dd-mm-yyyy'), 70, 4, 100000050, to_date('16-10-2008', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('821 Oslo', to_date('13-04-2000', 'dd-mm-yyyy'), 71, 16, 100000069, to_date('17-06-2010', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('953 Bonham Street', to_date('08-06-2004', 'dd-mm-yyyy'), 74, 17, 100000172, to_date('16-10-2008', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('21 Murdock Street', to_date('22-01-1973', 'dd-mm-yyyy'), 77, 19, 100000232, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('26 Brando', to_date('10-02-1993', 'dd-mm-yyyy'), 78, 15, 100000311, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('81st Street', to_date('30-08-1976', 'dd-mm-yyyy'), 81, 11, 100000388, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('93rd Street', to_date('12-11-2002', 'dd-mm-yyyy'), 82, 6, 100000225, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('28 Dwight Drive', to_date('27-06-1997', 'dd-mm-yyyy'), 85, 16, 100000201, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('34 Juliet Street', to_date('10-08-2000', 'dd-mm-yyyy'), 86, 10, 100000098, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('30 Caan Street', to_date('16-12-1960', 'dd-mm-yyyy'), 89, 7, 100000333, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('44 Orlando Drive', to_date('27-11-1962', 'dd-mm-yyyy'), 90, 6, 100000028, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('28 Heather', to_date('29-12-1974', 'dd-mm-yyyy'), 93, 1, 100000229, to_date('02-02-2018', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('58 Bernex Road', to_date('07-09-1971', 'dd-mm-yyyy'), 94, 16, 100000243, to_date('08-03-2013', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('58 Atkins Road', to_date('16-04-1976', 'dd-mm-yyyy'), 97, 1, 100000056, to_date('17-06-2010', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('241 Mortensen', to_date('30-01-1970', 'dd-mm-yyyy'), 99, 1, 100000131, to_date('17-06-2010', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('31 Coburn Street', to_date('19-07-1987', 'dd-mm-yyyy'), 100, 9, 100000134, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('74 Kaysville Road', to_date('12-06-1960', 'dd-mm-yyyy'), 103, 18, 100000198, to_date('02-02-2018', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('59 Warburton Road', to_date('02-10-2001', 'dd-mm-yyyy'), 105, 17, 100000008, to_date('17-06-2010', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('96 Doug', to_date('01-05-1969', 'dd-mm-yyyy'), 106, 11, 100000182, to_date('16-10-2008', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('32nd Street', to_date('19-12-1961', 'dd-mm-yyyy'), 109, 6, 100000245, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('951 Jenkins Street', to_date('12-10-1995', 'dd-mm-yyyy'), 110, 8, 100000319, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('1 Ammons Drive', to_date('09-07-1964', 'dd-mm-yyyy'), 113, 19, 100000381, to_date('02-02-2018', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('12nd Street', to_date('26-04-1977', 'dd-mm-yyyy'), 114, 9, 100000147, to_date('16-10-2008', 'dd-mm-yyyy'), 'angelakingscote@clickbank.net');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('29 Mickey Street', to_date('01-03-1982', 'dd-mm-yyyy'), 117, 19, 100000308, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('43 Edenbridge Drive', to_date('03-07-1993', 'dd-mm-yyyy'), 118, 7, 100000322, to_date('16-10-2008', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('5 Holly Road', to_date('22-02-1966', 'dd-mm-yyyy'), 121, 5, 100000195, to_date('19-04-2017', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('3 Cocker', to_date('21-11-2000', 'dd-mm-yyyy'), 122, 13, 100000318, to_date('02-02-2018', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('55 Itu Drive', to_date('07-01-2004', 'dd-mm-yyyy'), 125, 5, 100000151, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('92 Skerritt Blvd', to_date('22-05-1966', 'dd-mm-yyyy'), 126, 12, 100000094, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('31st Street', to_date('29-11-1980', 'dd-mm-yyyy'), 129, 18, 100000033, to_date('19-04-2017', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('3 Edwin Blvd', to_date('24-09-1961', 'dd-mm-yyyy'), 130, 20, 100000353, to_date('02-02-2018', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('16 Alexander Road', to_date('25-06-1971', 'dd-mm-yyyy'), 133, 7, 100000203, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('61 Estevez Ave', to_date('12-02-1981', 'dd-mm-yyyy'), 134, 10, 100000375, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('448 Collie Blvd', to_date('16-06-2004', 'dd-mm-yyyy'), 137, 11, 100000313, to_date('02-02-2018', 'dd-mm-yyyy'), 'ainsleeenever@sakura.ne.jp');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('26 Neville Drive', to_date('03-08-1987', 'dd-mm-yyyy'), 138, 5, 100000320, to_date('19-04-2017', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('17 Anderson Blvd', to_date('28-08-1972', 'dd-mm-yyyy'), 141, 16, 100000323, to_date('08-03-2013', 'dd-mm-yyyy'), 'willamelody@go.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('33rd Street', to_date('14-05-1961', 'dd-mm-yyyy'), 142, 10, 100000085, to_date('08-03-2013', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('23 Nathan Ave', to_date('28-11-2001', 'dd-mm-yyyy'), 143, 7, 100000390, to_date('16-10-2008', 'dd-mm-yyyy'), 'luciatropman@dedecms.com');
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id, m_dateofjoining, m_mail)
values ('20 Burmester Road', to_date('09-09-1998', 'dd-mm-yyyy'), 146, 19, 100000196, to_date('17-06-2010', 'dd-mm-yyyy'), 'aeriellnasey@flavors.me');
commit;
prompt 199 records loaded
prompt Loading SERVICEGIVER...
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Asus P4C800 Deluxe intel 875 Chip 800FSB DDR SATA ATA133 RAID GIGABIT LAN USB2.0 ATX Retail Box + In', 34);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, '9011 ATX Mid Server Case 450W w/3 case fans', 140);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'ADS External USB 2.0 Drive Kit', 31);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Mitsumi optical mouse.', 40);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Boka 306 Sub Woofer Flat Speaker system', 59);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'ATA 100 Controller Card PCI', 94);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2500+ & Gigabyte 7N400Pro w/ 313M case . W/ Free PS2 Mouse.', 123);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD MP 1500+ Gigabyte GA-7DPXDW Dual CPU M/B +Fan (one cpu only)', 28);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Boka 1050 Sub Woofer and Speakers', 6);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'MITSUMI 54X CD-Rom Black.', 144);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Microsoft Office 2000 Small Biz edition', 161);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMD XP 3000+ Barton CPU ASUS A7N8X Deluxe NVIDIA Force2 w/ Antec Performance plus II 1040B Case.', 176);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Gigabyte GA-7VA Motherboard w/ AGP 8x.', 33);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'C Rimm', 46);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Biostar M7SXF P4 478pin M/B Intel P4 1;8ghz CPU + Fan(BOx)Support DDR DIMM', 19);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'Achieve Gold Dual Fan 550Watt PowerSupply.', 47);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Combo Intel Celeron 1.1Ghz (Box)Tulatin core Biostar M6VLR m/b (Free AMR Modem.)', 153);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'Intel D875PBZ M/B onboard S-ATA 150.', 63);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 1.6Ghz retail CPU + Gigabyte GA-8ID533 M/B + Fan.', 88);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2700+ CPU ASUS A7N8X Deluxe NVIDIA Force2', 82);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Logitech Smart Click 310 Camera', 95);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2000+ CPU; Gigabyte GA-7VA M/B.', 145);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 1.8Ghz retail CPU + Gigabyte GA-8ID533 M/B + Fan.', 132);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Gigabyte GA-7VA Motherboard w/ AGP 8x.', 139);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMDXP2400/128M/30G Black Complete System.', 179);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMD XP 1600+ CPU (OEM)', 174);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'ADS Technologies Firewire External Drive.', 170);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Sony 48x24x40 and 16x CD-RW/DVD OEM.', 84);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Asus P4C800 Deluxe intel 875 Chip 800FSB DDR SATA ATA133 RAID GIGABIT LAN USB2.0 ATX Retail Box + In', 163);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'AMD XP 2800+ Retail box.', 107);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Dynatron CPU Cooler DF1206BH AMD Athlon\Duron Fan. (AMD Recommend)', 177);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Fast Ethernet 10/100 8 port switching hub', 143);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 3.06ghz CPU + Fan(BOx)with Hyper Threading w/ Gigabyte 8IPE1000 Pro MotherBoard.', 76);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 1700+ & Gigabyte GA-7VKML MB w/313N case. W/ Free PS2 Mouse.', 116);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Sony 48x24x48 and 16x CD-RW/DVD OEM.', 137);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 1.8ghz CPU + Fan(BOx) w/ Gigabyte GA-8IE800 Intel®845E Chipset.', 136);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2100+ Box w/Fan & Biostar M7VKQ Pro MB w/ 313M Case. W/ PS2 Mouse.', 127);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Fast Ethernet 10/100 8 port switching hub', 162);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'AMD XP 1800+ & Gigabyte GA-7DXE MB w/ 313M Case W/ Free PS2 Mouse.', 126);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2400+ CPU; Gigabyte GA-7N400Pro M/B(W/DDR400 up to 3GB/ATA133 Raid/USB2.0) +Fan.', 22);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'xAMD XP 1600+ Biostar M7VIB M/B + Cooler master fan', 188);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Cooler Master Ball Bearing Case Fan', 96);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel P4 2.4 Ghz CPU BOX (800Mhz)', 133);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Combo Intel P4 1.9ghz CPU + Fan(BOx)Biostar M7SXF P4 478pin M/B Support DDR DIMM', 74);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Biostar M7VKQ Duron 850Mhz B/B w/Video/Sound &10/100 LAN 312case.', 39);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2200+ & Biostar M7VIK KT400 MB w/ 313M case. Free PS2 Mouse.', 173);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'GigaByte G-Max Intel P4 Flex ATX Platform .', 154);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Celeron 1.8Ghz/128M/30G Black Complete System.', 11);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2100+ Box & Gigabyte GA-7DXE MB w/ 313M Case. W/ Free PS2 Mouse.', 182);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'YS AMD T-Bird 1.2 Ghz Performance Series', 92);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Sony 48x24x48 and 16x CD-RW/DVD OEM.', 148);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'KIT Keyboard Mouse and Speakers to match Black cases.', 112);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Combo AMD XP 2500+ Biostar M7VIK Skt A MotherBoard; KT400.', 13);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Combo AMD XP 2000+ CPU; Gigabyte GA-7VT600L M/B(W/DDR400 up to 3GB/ATA133 Raid/USB2.0) +Fan.', 73);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel D875PBZ M/B onboard S-ATA 150.', 171);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'ADS 2 Port USB Pci card', 151);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Biostar M7VIG-Pro Skt A MotherBoard w/ OnBoard Video/sound/Lan.', 97);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Pentium4 2.4ghz & Intel D845PESV MB w/ 313M Case. W/ Free PS2 Mouse.', 85);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMD XP 1800+ & Gigabyte GA-7VKML MB w/ 313M case W/ Free PS2 Mouse.', 117);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '128Mb RDRam 800Mhz Kingston', 115);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Gigabyte GA-6VEML skt 370 M/B (With onboard sound and Video and Realtek Lan)', 150);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Biostar M7VKB Ver2.0 ATA100 socket A (w/30 day limit warranty)', 8);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2700+ CPU; Gigabyte GA-7VA M/B(W/8X AGP;DDR333 up to 3GB/ATA133 ) +Fan.', 169);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Pentium4 2.0ghz & Gigabyte 8IRXP MB w/ 313N Case. W/ Free PS2 Mouse.', 49);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2700+ CPU ASUS A7N8X Deluxe NVIDIA Force2', 108);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Combo AMD Duron 1.2Ghz cpu Gigabyte GA-7VKMLS m/b fan.', 102);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'HP 1300 Laser Jet New.', 159);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2000+ & Biostar M7VIG-Pro MB w/ 313M case. Free PS2 Mouse.', 118);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'GA-SINXP1394(GA-8SQ800 Ultra2) (SiS 655 Chipset) w/ Pentium 4 2.4 Ghz (Box CPU)', 87);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Dynatron CPU Cooler DF1206BH AMD Athlon\Duron Fan. (AMD Recommend)', 9);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Black Complete Computer System w/ Mouse KeyBoard and Speakers(Free AMR Moden). (Duron 1.3)', 66);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'ADS USB2000 USB Turbo 2.0 pci Controller card', 128);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'AMD XP 2200+ Retail box.', 101);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Seagate Baraccuda 40Gb 7200rpm', 186);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'Hewlett Packard Color Deskjet HP 3420 .( Comes with Sample of HP Paper. HP Bright White Paper; HP Gl', 121);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2200+ & Biostar M7VIK KT400 MB w/ 313M case. Free PS2 Mouse.', 165);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMD 1.3Ghz BareBone System Free Mouse', 21);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '312B ATX Case 250W P4/AMD Ready Power Supply.', 65);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'YS Intel P4 2.0Ghz Server Solution', 7);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '313D Black 400W P4/AMD 2xUSB', 44);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Gigabyte GA-7DPXDW-P Dual AMD Server board w/RAID up to 4GB of Registered DDR memory', 158);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '313M ATX color Case blue 300W P4 w/ front USB & case fan', 93);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'Combo Intel Celeron 1.7Ghz (Box CPU)+ Biostar U8668D m/b (478pin)CPU & Fan Support .', 4);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 2.0ghz Gigabyte GA-8LD533 m/b + fan.', 181);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Cooler Master Socket A CopperHeatSync Fan HSC-V62', 53);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2500+ Barton CPU ASUS A7N8X Deluxe NVIDIA Force2 w/ Antec Performance plus II 1040B Case.', 61);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Logitech Smart Click 310 Camera', 68);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Pentium4 1.6Ghz & Biostar M7TDB MB w/ 313M Case.', 155);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'Pentiume 4 3.0Ghz 800FSB/512M/80G Black Complete System.', 69);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Intel Pentium4 2.0ghz & Gigabyte 8IRXP MB w/ 313N Case. W/ Free PS2 Mouse.', 1);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Cooler Master Copper HEAT PIPE Cooler. HHC-001', 15);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Case Fan 3 1/2"(80mm) 12V', 200);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMDXP2200/128M/30G Black Complete System.', 64);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2200+ & Gigabyte 7DXE w/ 313M case . W/ Free PS2 Mouse.', 90);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2500+ Gigabyte GA-7VA M/B.', 79);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'TV Tuner card PCI (KWorld M878A)', 192);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMDXP2000+ Box BiostarM7VIG-Pro', 134);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Combo Intel P4 1.6ghz CPU + Fan (BOX);Biostar M7SXF P4 478pin M/B Support DDR DIMM', 77);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Pentium4 2.0ghz & Gigabyte 8ID533 MB w/ 313N Case. W/ Free PS2 Mouse.', 122);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'ASUS A7N8X Deluxe NVIDIA Force2 .', 172);
commit;
prompt 100 records committed...
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Combo Intel Celeron 1.1Ghz (Box)Tulatin core Biostar M6VLR m/b (Free AMR Modem.)', 113);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'USB Cable 6ft. Long.', 199);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'YS Intel Celeron 1.1GHz Work Station Series', 50);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 2000+ cpu Gigabyte GA-7VKMLS m/b fan.', 195);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 1700+ & Gigabyte GA-7ZXE MB w/ 313N Case. W/ Free PS2 Mouse.', 75);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Biostar M7VIG-Pro Skt A MotherBoard w/ OnBoard Video/sound/Lan.', 5);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel P4 1;8Ghz (478)pin 512K 3 Year MFG warr.', 196);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (20, 'AMD XP 1700+ & Gigabyte GA-7ZXE MB w/ 313N Case. W/ Free PS2 Mouse.', 106);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Boka 2000 Sub Woofer Speaker System', 10);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'AMD Duron 1.3 Ghz (Oem)', 129);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'SIS Xabre200 64MB DDR AGP 8X DVI+TV+CRT by Power Color', 57);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'Combo AMD XP 2100+ w/ Cpu Fan & Biostar M7VKQ +', 152);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel D875PBZ M/B onboard S-ATA 150.', 100);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Seagate 60GB 7200rpm EIDE Hard Drive Barracuda V ST360015A (OEM).', 194);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Mitsumi DW-7801TE DVD Duplicator/Burner.', 109);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'Intel D845PESV P4 M/B DDR-333 support.', 32);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'DVI to 15pin CRT adapter', 157);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, '400 Watt UL ATX Power Supply Support AMD; P3;P4;and with Dual Fan.', 104);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 2100+ (Box) & Gigabyte GA-7VKMLE MB w/ 313M Color Case. W/ Free PS2 Mouse.', 36);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Combo AMD XP 2700+ CPU; Gigabyte GA-7VA M/B.', 142);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'Combo AMD XP 2500+ Biostar M7VIK Skt A MotherBoard; KT400.', 184);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 2.0ghz Gigabyte GA-8LS533 m/b + fan.', 120);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '128Mb DDRam PC2100 Kingston', 147);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD Duron 1.1Ghz CPU and Cooler Fan w/Biostar M7VKQ-Pro M/b (Support DDR) and (Free Modem.)', 99);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Gigabyte GA-7DPXDW-P Dual AMD Server board w/RAID up to 4GB of Registered DDR memory', 72);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo AMD XP 1900+ cpu Gigabyte GA-7VKMLS m/b fan.', 130);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, '313G-B ATX case 400W P4/AMD Free Fan and 2 Front USB.', 146);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Logitech Cordless Elite Duo Optical Kit(KB/MS)', 48);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Black Sony CD-RW 52x24x52x .', 135);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (25, 'Gigabyte GA-8ID533 Socket 478 Intel®', 187);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'ATA 100 RAID controller card', 178);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Intel Celeron 1.7ghz & Biostar U8668D. W/ Free CNR 56k & PS2 Mouse.', 138);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel Celeron 1.7G Gigabyte MB GA-8LS533', 198);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (10, 'AMD XP 2500+ Barton (OEM). (with 333Mhz Front Side Bus w/ 512k Cache).', 35);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (30, 'AMD XP 1700+ & Gigabyte GA-7DXE MB w/ 313N Case. W/ Free PS2 Mouse.', 189);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'AMD XP 1800+ & Gigabyte GA-7VR MB w/ 313N Case. W/ Free PS2 Mouse.', 185);
insert into SERVICEGIVER (sg_price, sg_details, sgm_id)
values (null, 'Combo Intel P4 2.0Ghz 478pin(box)CPU + Gigabyte GA-8IRX (DDR up to 2GB/4 USB)M/B + Fan.', 56);
commit;
...
values ('M', 9, 4, 1, 152);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('M', 12, 3, 10, 112);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('M', 5, 8, 4, 74);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('F', 6, 3, 4, 115);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('F', 12, 12, 10, 113);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('M', 6, 2, 9, 155);
insert into BABYSITTING (b_gender, b_age, b_yearsofexperience, b_maxnumofchildren, sgm_id)
values ('F', 7, 6, 7, 95);
...
values (null, 'Mental Health Counse', 3, 57);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Parenting Coach', 10, 11);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 9, 120);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Home Organization Co', 9, 34);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Pediatric Sleep Spec', 4, 148);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Doula', 4, 161);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Lactation Consultant', 8, 93);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Home Organization Co', 2, 199);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Babywearing Consulta', 10, 136);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Babywearing Consulta', 6, 90);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 2, 132);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Pediatric Sleep Spec', 5, 84);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Nutrition Consultant', 7, 176);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Doula', 7, 101);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 1, 7);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Mental Health Counse', 8, 177);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Childproofing Consul', 1, 35);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Sleep Consultant', 9, 163);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Postpartum Doula', 8, 170);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Sleep Consultant', 2, 73);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Doula', 9, 137);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Sleep Consultant', 7, 185);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Financial Consultant', 6, 36);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Parenting Coach', 6, 188);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 5, 32);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Childproofing Consul', 2, 44);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Pediatric Sleep Spec', 1, 158);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 5, 140);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Financial Consultant', 4, 10);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 1, 157);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 3, 56);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 3, 127);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 5, 121);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Home Organization Co', 9, 61);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Pediatric Sleep Spec', 9, 130);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'General', 3, 8);
insert into CONSULTING (cns_location, cns_type, cns_yearsofexperience, sgm_id)
values (null, 'Postpartum Doula', 6, 49);
commit;
...
values ('Thursday', '9:30', '20:30', 5, null, 44);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '14:30', '17:00', 5, null, 11);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '12:30', '17:30', 2, null, 7);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '11:30', '20:30', 3, null, 162);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '11:00', '17:00', 4, null, 66);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '10:00', '16:00', 3, null, 169);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '11:00', '20:00', 4, null, 182);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '9:00', '21:00', 4, null, 57);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '8:00', '22:00', 1, null, 185);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '14:30', '22:00', 1, null, 146);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '12:30', '22:30', 5, null, 146);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '11:00', '23:30', 4, null, 46);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '9:30', '22:00', 2, null, 9);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '10:00', '16:00', 5, null, 102);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '11:30', '23:00', 5, null, 165);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Wednesday', '12:00', '22:00', 1, null, 126);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '14:00', '15:30', 5, null, 118);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '8:00', '23:30', 5, null, 150);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '13:30', '23:00', 1, null, 109);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '9:30', '17:00', 4, null, 187);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Wednesday', '13:30', '15:30', 3, null, 68);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Wednesday', '14:00', '23:00', 1, null, 113);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '10:30', '23:00', 1, null, 28);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '14:30', '21:00', 1, null, 32);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '10:00', '15:30', 5, null, 99);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '11:30', '19:00', 2, null, 169);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '14:00', '15:30', 5, null, 13);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '11:30', '21:00', 3, null, 53);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Thursday', '13:30', '16:30', 5, null, 152);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Wednesday', '9:30', '23:00', 3, null, 184);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '13:30', '15:30', 4, null, 82);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Monday', '8:00', '22:30', 1, null, 121);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '11:00', '20:00', 2, null, 122);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Wednesday', '8:30', '22:00', 3, null, 135);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '10:00', '17:30', 3, null, 104);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '13:00', '17:30', 5, null, 182);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Sunday', '12:00', '19:00', 2, null, 68);
insert into TIMES (t_dayofweek, t_starttime, t_endtime, t_num, t_constraints, sgm_id)
values ('Tuesday', '13:30', '17:30', 2, null, 109);
commit;
...
values (to_date('20-09-2021', 'dd-mm-yyyy'), '8:00', '21:30', 4, 185, 36);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('20-10-2020', 'dd-mm-yyyy'), '14:30', '16:00', null, 178, 79);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('15-07-2023', 'dd-mm-yyyy'), '9:30', '22:00', null, 16, 137);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('15-01-2023', 'dd-mm-yyyy'), '8:30', '15:30', 4, 153, 113);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('24-02-2021', 'dd-mm-yyyy'), '12:30', '17:30', null, 48, 44);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('04-10-2023', 'dd-mm-yyyy'), '14:30', '22:00', 4, 150, 79);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('09-03-2020', 'dd-mm-yyyy'), '9:30', '21:00', 5, 121, 104);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('22-10-2022', 'dd-mm-yyyy'), '13:30', '16:00', 5, 158, 200);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('26-11-2022', 'dd-mm-yyyy'), '12:00', '22:00', null, 37, 90);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('17-10-2022', 'dd-mm-yyyy'), '11:00', '22:30', 4, 61, 176);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('10-03-2020', 'dd-mm-yyyy'), '11:00', '19:00', 5, 130, 33);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('28-10-2020', 'dd-mm-yyyy'), '14:30', '23:30', 5, 115, 152);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('25-04-2023', 'dd-mm-yyyy'), '14:30', '22:00', 4, 152, 95);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('08-04-2020', 'dd-mm-yyyy'), '11:00', '22:00', 5, 42, 9);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('03-09-2023', 'dd-mm-yyyy'), '8:30', '20:00', null, 167, 137);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('28-06-2022', 'dd-mm-yyyy'), '13:30', '19:30', 5, 117, 198);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('10-08-2022', 'dd-mm-yyyy'), '14:00', '22:30', null, 52, 150);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('26-10-2020', 'dd-mm-yyyy'), '10:30', '16:00', null, 86, 50);
insert into YOLEDETSERVICEGIVER (ysg_dateofservice, ysg_starttime, ysg_endtime, ysg_rating, ym_id, sgm_id)
values (to_date('01-04-2021', 'dd-mm-yyyy'), '10:00', '21:00', 5, 87, 136);
commit;
prompt 19 records loaded
prompt Enabling foreign key constraints for COMMUNITYMEMBER...
alter table COMMUNITYMEMBER enable constraint SYS_C0010900;
alter table COMMUNITYMEMBER enable constraint SYS_C0010901;
prompt Enabling foreign key constraints for SERVICEGIVER...
alter table SERVICEGIVER enable constraint SYS_C0010931;
prompt Enabling foreign key constraints for BABYSITTING...
alter table BABYSITTING enable constraint SYS_C0010935;
prompt Enabling foreign key constraints for BIRTH...
alter table BIRTH enable constraint SYS_C0010908;
prompt Enabling foreign key constraints for CLEANING...
alter table CLEANING enable constraint SYS_C0010938;
prompt Enabling foreign key constraints for CONSULTING...
alter table CONSULTING enable constraint SYS_C0010953;
prompt Enabling foreign key constraints for DONATION...
alter table DONATION enable constraint SYS_C0010914;
alter table DONATION enable constraint SYS_C0010915;
prompt Enabling foreign key constraints for EXTERNAL_DONOR...
alter table EXTERNAL_DONOR enable constraint SYS_C0010921;
prompt Enabling foreign key constraints for SPENDING...
alter table SPENDING enable constraint SYS_C0010928;
prompt Enabling foreign key constraints for TIMES...
alter table TIMES enable constraint SYS_C0010955;
prompt Enabling foreign key constraints for YOLEDETSERVICEGIVER...
alter table YOLEDETSERVICEGIVER enable constraint SYS_C0010957;
alter table YOLEDETSERVICEGIVER enable constraint SYS_C0010958;
