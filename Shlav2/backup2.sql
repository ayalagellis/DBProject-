...
prompt Created by gelli on Friday, June 28, 2024
set feedback off
set define off
...
alter table COMMUNITYMEMBER disable constraint SYS_C009596;
alter table COMMUNITYMEMBER disable constraint SYS_C009597;
prompt Disabling foreign key constraints for BIRTH...
alter table BIRTH disable constraint SYS_C009616;
prompt Disabling foreign key constraints for DONATION...
alter table DONATION disable constraint SYS_C009608;
alter table DONATION disable constraint SYS_C009609;
prompt Disabling foreign key constraints for EXTERNAL_DONOR...
alter table EXTERNAL_DONOR disable constraint SYS_C009602;
prompt Disabling foreign key constraints for SPENDING...
alter table SPENDING disable constraint SYS_C009623;
...
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
values ('168 Anières Drive', to_date('22-06-1999', 'dd-mm-yyyy'), 23, 17, 100000255);
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
...
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
values ('40 Eisenhüttenstadt Drive', to_date('22-02-1981', 'dd-mm-yyyy'), 45, 2, 100000269);
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
...
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
values ('4 Mönchengladbach Road', to_date('28-02-1977', 'dd-mm-yyyy'), 139, 1, 100000372);
insert into COMMUNITYMEMBER (address, date_of_birth, member_id, community_id, person_id)
...
alter table COMMUNITYMEMBER enable constraint SYS_C009596;
alter table COMMUNITYMEMBER enable constraint SYS_C009597;
prompt Enabling foreign key constraints for BIRTH...
alter table BIRTH enable constraint SYS_C009616;
prompt Enabling foreign key constraints for DONATION...
alter table DONATION enable constraint SYS_C009608;
alter table DONATION enable constraint SYS_C009609;
prompt Enabling foreign key constraints for EXTERNAL_DONOR...
alter table EXTERNAL_DONOR enable constraint SYS_C009602;
prompt Enabling foreign key constraints for SPENDING...
alter table SPENDING enable constraint SYS_C009623;
